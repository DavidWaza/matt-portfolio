          ...
          <Box sx={{ flexGrow: 1 }}>
            <Grid container spacing={2}>
              <Grid item xs={12} md={6} lg={6}>
                <div className=" lg:h-[35rem] bg-[#DA6445] p-10 hover:scale-105 hover:transition-all hover:ease-in duration-300 delay-150">
                  ...
                  <ul className="grid lg:grid-cols-2 w-full avant-semi mt-3 text-[#1D232A] text-[0.99rem] md:text-xl">
                    {webDev.map((list, index) => {
                      return (
                        <div
                          key={index}
                          className="flex gap-2 lg:my-4 my-[7px]"
                        >
                  ...
                  <Link href={"/#"}>
                    <button className="w-full py-7 text-center text-[#DA6445] bg-black mt-[85px] hover:bg-transparent ease-in hover:text-black duration-300 hover:border-2 border-black">
                      Show Portfolio
                    </button>
                  </Link>
                </div>
              ...
              <Grid item xs={12} md={6} lg={6}>
                <div className=" lg:h-[35rem] bg-[#B4AB9A] p-10 hover:scale-105 hover:transition-all hover:ease-in duration-300 delay-150">
                  <p className="avant-semi text-[1.6rem] md:text-8xl text-[#1D232A] text-center md:text-left">
                    Prolific Investor
                  </p>
                  <br />
